    ...
    def get_users(self):
        try:
            ...
            with conection.cursor() as cursor:
                cursor.execute(
                    "SELECT id, dc_nombre, dc_contrasena, dc_correo_electronico, dc_telefono, df_fecha_solicitud FROM tb_usuario"
                )
    ...
    def get_user_by_id(cls, user_id):
        try:
            ...
            with connection.cursor() as cursor:
                cursor.execute(
                    "SELECT dc_contrasena, dc_correo_electronico, dc_nombre, dc_telefono, df_fecha_solicitud FROM tb_usuario WHERE id = %s",
                    (user_id,),
                )
        ...
        try:
            ...
            with conn.cursor() as cursor:
                ...
                values = (
                    ...
                    user.dc_telefono,
                    user.tb_nivel_artes_marciales_id,
                    user.df_fecha_solicitud,
                    user.tb_tipo_usuario_id,
                    user.tb_usuario_estado_id,
                    user.tb_nivel_id,
                    user.tb_contacto_emergencia_id,
                )
    ...
    def update_user(cls, user_id, new_user_data):
        try:
            ...
            with conn.cursor() as cursor:
                ...
                values = (
                    new_user_data["dc_nombre"],
                    new_user_data["dc_contrasena"],
                    new_user_data["dc_correo_electronico"],
                    new_user_data["dc_telefono"],
                    new_user_data["df_fecha_solicitud"],
                    user_id,
                )
                cursor.execute(sql, values)
                affected_rows = cursor.rowcount
